...
class SetB:
    ...
    def __call__(self, ctx: StepContext) -> StepContext:
        return ctx.replace(metadata=MappingProxyType({**ctx.metadata, "b": ctx.metadata["a"] + 1}))
...
class SetC:
    ...
    def __call__(self, ctx: StepContext) -> StepContext:
        return ctx.replace(metadata=MappingProxyType({**ctx.metadata, "c": ctx.metadata["b"] * 2}))
...
class AsyncStep:
    ...
    async def __call__(self, ctx: StepContext) -> StepContext:
        ...
        return ctx.replace(metadata=MappingProxyType({**ctx.metadata, "async_done": True}))
...
class BoundaryStep:
    ...
    def __call__(self, ctx: StepContext) -> StepContext:
        ...
        return ctx.replace(metadata=MappingProxyType({**ctx.metadata, "bg_result": True}))
...
class SerialStep:
    ...
    def __call__(self, ctx: StepContext) -> StepContext:
        ...
        return ctx.replace(metadata=MappingProxyType({**ctx.metadata, "serial_done": True}))
