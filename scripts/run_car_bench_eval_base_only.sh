#!/usr/bin/env bash
# =============================================================================
# CAR-bench Base-Only Evaluation (Section 12a): 13 configs in parallel tmux
#
# Tests the mixed-training hypothesis by evaluating skillbooks trained on
# only base traces (skillbook_49.json) against only base test tasks.
#
...
#
# Skillbook types:
#   median          - Base-50 median run markdown (appended to wiki.md)
#   consensus       - Base-50 consensus (t>=3) markdown (appended to wiki.md)
#   opus-median     - Opus-compressed base-50 median (appended to wiki.md)
#
# Prerequisites:
#   1. Run: uv run python scripts/prepare_base_only_eval.py
#   2. Verify wiki files exist in benchmarks/car-bench/prepared_wikis/
#
# Usage:
#   chmod +x scripts/run_car_bench_eval_base_only.sh
#   ./scripts/run_car_bench_eval_base_only.sh          # Launch all 13 configs
#   ./scripts/run_car_bench_eval_base_only.sh --dry-run  # Print commands only
# =============================================================================
...
OUTPUT_DIR="$PROJECT_DIR/results/car_bench_eval_base_only"
TMUX_SESSION_PREFIX="car-base50"
MODEL="us.anthropic.claude-haiku-4-5-20251001-v1:0"
MODEL_PROVIDER="bedrock"
USER_MODEL="gemini-2.5-flash"
K=4
MAX_CONCURRENCY=5
# Base tasks only (the whole point of this experiment)
TASK_TYPES=("base")
DRY_RUN=false
...
# Haiku source: base-50 variants
CONFIGS["haiku-nobudget-base50-median"]="wiki_haiku-nobudget-base50-median.md"
CONFIGS["haiku-nobudget-base50-consensus"]="wiki_haiku-nobudget-base50-consensus.md"
CONFIGS["haiku-nobudget-base50-opus-median"]="wiki_haiku-nobudget-base50-opus-median.md"
CONFIGS["haiku-500-base50-median"]="wiki_haiku-500-base50-median.md"
CONFIGS["haiku-500-base50-consensus"]="wiki_haiku-500-base50-consensus.md"
CONFIGS["haiku-500-base50-opus-median"]="wiki_haiku-500-base50-opus-median.md"

# Sonnet source: base-50 variants
CONFIGS["sonnet-nobudget-base50-median"]="wiki_sonnet-nobudget-base50-median.md"
CONFIGS["sonnet-nobudget-base50-consensus"]="wiki_sonnet-nobudget-base50-consensus.md"
CONFIGS["sonnet-nobudget-base50-opus-median"]="wiki_sonnet-nobudget-base50-opus-median.md"
CONFIGS["sonnet-500-base50-median"]="wiki_sonnet-500-base50-median.md"
CONFIGS["sonnet-500-base50-consensus"]="wiki_sonnet-500-base50-consensus.md"
CONFIGS["sonnet-500-base50-opus-median"]="wiki_sonnet-500-base50-opus-median.md"
...
if [[ $MISSING -gt 0 ]]; then
    echo "ERROR: $MISSING wiki files missing. Run prepare_base_only_eval.py first."
    exit 1
fi
...
echo "  Task types:     ${TASK_TYPES[*]} (base only — Section 12a)"
echo ""
